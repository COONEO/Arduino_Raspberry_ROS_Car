...
class BaseController:
    ...
    def poll(self):
        ...
        if now > self.t_next:
            ...
            dt = now - self.then
            self.then = now
            dt = dt.to_sec()  #convert to seconds
    ...
    def cmdVelCallback(self, req):
        ...
        if x == 0:
            # Turn in place
            right = th * self.wheel_track / 2.0    # * self.gear_reduction / 2.0
            left = -right
        elif th == 0:
            ...
            left = x - th * self.wheel_track / 2.0     # * self.gear_reduction / 2.0
            right = x + th * self.wheel_track / 2.0    # * self.gear_reduction / 2.0
